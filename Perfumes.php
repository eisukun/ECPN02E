<?php
include 'process/rian_pos_fill.php';
    ...
    <div class="d-flex">
        <div class="vh-100 sticky-top" style="width: 320px; background-color:#111927">
            ...
            <ul class="nav flex-column mb-auto mx-4">
                ...
                <li>
                <a href="Bags.php" class="nav-link text-white mb-2 <?php echo ($user_privilege == 1 || $user_privilege == 3) ? '' : 'd-none' ?> "style="background-color: #343b47;border-radius: 5px;">
                        POS
                    </a>
                </li>
                <li>
            ...
            <main class="container border bg-white">
                ...
                <div class="">
                        ...
                        <div class="btn-group d-flex justify-content-center align-items-center">
                            <div>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="Bags.php">Bags</a></li>
                                    <li><a class="dropdown-item" href="Perfumes.php">Perfumes</a></li>
                    ...
                    <div class="row mx-auto row-cols-5">
                        ...
                        for ($i = 1; $i < 21; $i++) {
                            $label = "OXGN $i";
                            $price = "$Perfumes_prices[$i]";
                            echo "
                            <div class='col' onclick='handleItems(\"$label\", \"$price\")' role='button'>
                                <div class='card mb-3 mx-3 ' style='max-width: 300px;'>
                                    <div class='row g-0'>
                                        <img src='Images/Perfumes/$i.jpg' class='card-img-top rounded-start' alt='...' height='100' style='width:100%;height:5.2vw;object-fit:contain'/>
