    ...
    <div class="d-flex">
        ...
        <div class="vh-100 sticky-top " style="width: 320px; background-color:#111927">
            ...
            <ul class="nav flex-column mb-auto mx-4">
                ...
                <li>
                    <a href="payroll_report.php" class="nav-link text-white  mb-2 <?php echo ($user_privilege == 1 || $user_privilege == 2) ? '' : 'd-none' ?>" style="background-color: #343b47;border-radius: 5px;">
                        Payroll Report
                    </a>
                </li>
                <li>
        ...
        <div class=" flex-grow-1" style="background-color: #f9fafc;">
            <div class="px-5 my-5">
                <h1 class="d-flex justify-content-center m-2 fw-bold" style="font-size:30px;">Payroll Report</h1>
                            ...
                            <tbody>
                                ...
                                if ($result) {
                                    while ($item = $result->fetch_assoc()) {
                                        echo "
                                <tr class='clickable-row border' style='cursor: pointer' data-href='Payroll_page.php?id={$item['employee_no']}'>
