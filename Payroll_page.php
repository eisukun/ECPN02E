...
include 'process/rian_payroll_fill.php';
...
<body style="background: black url(Images/bg_payroll.jpg);">
    <div class="flex-grow-1" style="border: #99b6d2ff;">
        <div class="container">
            <h1 class="d-flex justify-content-center m-2 fw-bold" style="font-size:30px;">RIAN'S PAYROLL</h1>
                <!-- form inputs -->
